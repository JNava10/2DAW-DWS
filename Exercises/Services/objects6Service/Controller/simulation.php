<?php
require_once __DIR__ . '/Model/Snake.php';
require_once __DIR__ . '/Model/Nest.php';
require_once __DIR__ . '/Controller/ArrayBuilder.php';
...
function simSnakesLife(int $years, int $snakeQuantity): Nest {
    $nest = new Nest(ArrayBuilder::createSnakes($snakeQuantity));
